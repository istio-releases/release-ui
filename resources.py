...
def in_cache(args):
  ...
  key = start_date + end_date + datetype + state + branch + type + sort_method + descending
...
class Releases(Resource):
  ...
  def get(self):
    ...
    if cache_exists:
      ...
      response = filter_releases(adapter.get_releases(), args['state'], args['branch'], args['type'], args['start_date'], args['end_date'], args['datetype'], args['descending'])
