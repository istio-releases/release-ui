...
for i in range(number_of_releases):
  ...
  new_data[release_id]['started'] = random.randint(0, 1528000)
  new_data[release_id]['last_modified'] = random.randint(0, 1528000)
...
for i in range(10):
  ...
  new_data[task_id]['started'] = random.randint(0, 1528000)
  new_data[task_id]['last_modified'] = random.randint(0, 1528000)
