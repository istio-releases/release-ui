...
_GETRELEASEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='release.GetReleaseRequest.id', index=0,
...
_GETRELEASERESPONSE = _descriptor.Descriptor(
  ...
  full_name='release.GetReleaseResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='release', full_name='release.GetReleaseResponse.release', index=0,
...
_LISTRELEASESREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='state', full_name='release.ListReleasesRequest.state', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='labels', full_name='release.ListReleasesRequest.labels', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='from_timestamp', full_name='release.ListReleasesRequest.from_timestamp', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='to_timestamp', full_name='release.ListReleasesRequest.to_timestamp', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_count', full_name='release.ListReleasesRequest.max_count', index=4,
...
_RELEASEIDENTIFIER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='release.ReleaseIdentifier.id', index=0,
...
_GETRELEASERESPONSE.fields_by_name['release'].message_type = _SINGLERELEASE
...
GetReleaseResponse = _reflection.GeneratedProtocolMessageType('GetReleaseResponse', (_message.Message,), dict(
  DESCRIPTOR = _GETRELEASERESPONSE,
  __module__ = 'config_pb2'
  # @@protoc_insertion_point(class_scope:release.GetReleaseResponse)
  ))
